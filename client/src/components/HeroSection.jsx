...
const HeroSection = () => {
  ...
  return (
    ...
    bg-cover bg-center h-screen'>
        ...
        <h1 className='text-5xl md:text-[70px] md:leading-18 font-sembold
        ...
        <p className='max-w-md text-gray-300'>In a post-apocalyptic world where cities ride on wheels 
          ...
          two people meet in London and try to stop a conspriracy.
        </p>
        <button onClick={()=> navigate('/movies')} className='flex items-center gap-1 px-6 py-3 text-sm bg-primary
         hover:bg-primary-dull transition rounded-full font-medium cursor-pointrt'>
          Explore Movies
