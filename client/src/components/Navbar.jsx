  ...
  return (
    <div className='fixed top-0 left-0 z-50 w-full flex items-center justify-between px-6 md:px-16 lg:px-36 py-5'>
      <Link to='/' className='max-md:flex-1'>
        {/* RECOMMENDATION: Add descriptive alt text for the logo */}
        <img src={assets.logo} alt="Cinephile Logo" className='w-36 h-auto' />
      </Link>

      {/* FIX: Corrected Tailwind CSS classes below */}
      ...
      md:rounded-full backdrop-blur bg-black/70 md:bg-white/10 md:border border-gray-300/30 overflow-hidden
